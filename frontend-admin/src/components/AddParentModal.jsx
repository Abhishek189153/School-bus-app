...
const AddParentModal = ({ open, handleClose, refreshParents }) => {
  ...
  const validate = () => {
    const next = {};
    if (!formData.name.trim()) next.name = "Enter the parent's name";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box>
          <DialogTitle sx={{ p: 0, fontWeight: 600, lineHeight: 1.2 }}>
            Add Parent
          </DialogTitle>
          <Typography variant="body2" sx={{ opacity: 0.85 }}>
            Create a login for a parent to track their child's bus
          </Typography>
        </Box>
      </Box>
